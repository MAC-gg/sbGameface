...
namespace sbGameface.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            /* Get GameQs */
            var GameQs = _context.GameQ.Where(a => a.GameId == id).ToList();
            // null check
            if (GameQs == null) { return NotFound(); }
            // add to Model
            game.Qs = GameQs;

            /* Get GameQs */
            var GameStats = _context.GameStat.Where(a => a.GameId == id).ToList();
            // null check
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,TeamSize")] Game game)
        {
